...
export class InitialMigration1695792810539 implements MigrationInterface {
    name = 'InitialMigration1695792810539'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "Announcements" ("id" SERIAL NOT NULL, "brand" character varying(45) NOT NULL, "model" character varying(45) NOT NULL, "year" integer NOT NULL, "fuel" character varying(20) NOT NULL, "mileage" integer NOT NULL, "color" character varying(10) NOT NULL, "fipe" integer NOT NULL, "price" integer NOT NULL, "description" text NOT NULL, CONSTRAINT "PK_758fc79add0389104119de29de5" PRIMARY KEY ("id"))`);
